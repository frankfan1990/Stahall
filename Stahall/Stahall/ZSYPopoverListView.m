...
- (void)initTheInterface
{
    ...
    self.titleName.backgroundColor = [UIColor colorWithRed:76/255.0 green:60/255.0 blue:136/255.0 alpha:1];
    ...
    _mainPopoverListView.tableFooterView = footerView;
}
